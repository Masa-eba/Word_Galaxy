...
| 2D/3D画面表示 | 単語選択＆エッジ遷移 | 単語検索 |
|:---:|:---:|:---:|
| ![2D,3D画面表示](./1.gif) | ![単語選択とエッジ遷移](./2.gif) | ![単語検索](./3.gif) |

| 単語帳制作 | 単語帳の機能（ビュー＆テスト） |
|:---:|:---:|
| ![単語帳制作](./4.gif) | ![単語帳の機能](./5.gif) |

- **1. 2D,3D画面表示** … 単語ネットワークの2D/3D切り替え
- **2. 単語選択＆単語のエッジ遷移** … 関連単語の可視化
- **3. 単語検索** … 任意の単語を高速検索
- **4. 単語帳制作** … 好きな単語で自分だけの単語帳を作成
- **5. 単語帳の機能（ビュー＆テスト）** … 単語帳で学習＆テスト
